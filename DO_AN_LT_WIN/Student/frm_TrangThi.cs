...
{
    public partial class frm_TrangThi : Form
    {
        ...
        private string maKQ;
        public frm_TrangThi(string mamonhoc)
        {
        ...
        private void frm_TrangThi_Load(object sender, EventArgs e)
        {
                ...
                using (var transaction = context.Database.BeginTransaction())
                {
                    try
                    {
                        ...
                        int lastId = allMaBaiThi
                            ...
                            .DefaultIfEmpty(0)
                            .Max();
                        mabaithi = "BTCK" + (lastId + 1).ToString(); // Tạo mã mới
        ...
        private void btn_nopBai_Click(object sender, EventArgs e)
        {
            if (lbl_ThoiGian.Text.Contains("Hết giờ"))
            {
                ...
                if(xemKetQua == DialogResult.Yes)
                {
                    ...
                    form1.dim = (float)(correctAnswers * 0.5);
                    form1.makq = maKQ;
        ...
        private void frm_TrangThi_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (isThoat)
            {
